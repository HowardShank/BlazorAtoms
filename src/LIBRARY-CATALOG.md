...
- **Typography** — text primitives. `AtomTextCycle` (shipped) cycles a list of words/phrases in an
  ...
  auto-replays on word change, `Replay()` for on-demand repeat. Still to build: headings, body
  text, inline code, keyboard keys, truncation.
